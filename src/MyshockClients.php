...
class DomainRegistrationClient
{
     ...
     * @return (array{string,\ShockMedia\Generated\Domainregistration\DomainCheckStatus|null})[]
     */
    public function getCheckedDomains(
        ...
        $_apiCallResult = $this->httpClient->apiCall('DomainRegistration.getCheckedDomains', $_params);
        $var0 = array();
        foreach ($_apiCallResult as $element0) {
            $var1 = array();
            $var1[] = $element0[0];
            if ($element0[1] === NULL) {
                ...
                $var1[] = \ShockMedia\Generated\Domainregistration\DomainCheckStatus::from($element0[1]);
            }
            $var0[] = $var1;
        }
        /** @var (array{string,\ShockMedia\Generated\Domainregistration\DomainCheckStatus|null})[] $_result */
        $_result = $var0;
        return $_result;
    }
...
class ProjectClient
{
    ...
    /**
     * @return array{\ShockMedia\Generated\PageResult,\ShockMedia\Generated\Containers2\Project[]}
     */
    public function listProjects(
        \ShockMedia\Generated\PageRequest $page,
    ) {
        ...
        $var1 = array();
        foreach ($_apiCallResult[1] as $element1) {
            $var1[] = \ShockMedia\Generated\Containers2\Project::fromDecodedJson($element1);
        }
        $var0[] = $var1;
        /** @var array{\ShockMedia\Generated\PageResult,\ShockMedia\Generated\Containers2\Project[]} $_result */
        $_result = $var0;
        return $_result;
    }

    public function createProject(
        \ShockMedia\Generated\Containers2\Inputs\CreateProjectInput $input,
    ) {
        $_params = array(
            'input' => $input,
        );
        $_apiCallResult = $this->httpClient->apiCall('Project.createProject', $_params);
        /** @var int $_result */
        $_result = $_apiCallResult;
        return $_result;
    }
    ...
    public function getProject(
        ...
        $_result = \ShockMedia\Generated\Containers2\Project::fromDecodedJson($_apiCallResult);
        return $_result;
    }
    ...
    public function removeProject(
        ...
        $this->httpClient->apiCall('Project.removeProject', $_params);
    }
