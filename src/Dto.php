...
// generated on 2026-06-11T07:43:04.743294131Z
...
class AcquiredOffering
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        (
            $acquiredId, $surcharge, $quantity, $start, $startContract, $end, $earliestCancellationDate, $offeringCategory, $offeringType, $offeringName, $offeringPrice, $effectivePrice, $serviceName, $accountName, $managedApps, $servers, $extension
        );
    }
}
