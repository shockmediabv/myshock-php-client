...
// generated on 2026-06-08T16:44:55.825821959Z
...
class Info
{
     ...
     * @param $checkResult The results of the initial check.
     * @param $contactConfiguration Information regarding possible contacts, if available.
     * @param $planConfiguration Information regarding plan configuration, if available.
     */
    public function __construct
    (
        public readonly string $domain,
        public readonly \ShockMedia\Generated\Domainregistration\Info\CheckResult $checkResult,
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        $checkResult = \ShockMedia\Generated\Domainregistration\Info\CheckResult::fromDecodedJson($decodedJson['checkResult']);
        ...
        return new Info
        (
            $domain, $checkResult, $contactConfiguration, $planConfiguration
        );
    }
}
...
/**
 * The results of the initial check.
 */
class CheckResult
{
    /**
    ...
    (
        ...
        public readonly \ShockMedia\Generated\Domainregistration\CheckResult\TransferInfo|null $transferInfo,
    ) {
    }
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        if ($decodedJson['transferInfo'] === NULL) {
            ...
            $transferInfo = \ShockMedia\Generated\Domainregistration\CheckResult\TransferInfo::fromDecodedJson($decodedJson['transferInfo']);
        }

        return new CheckResult
        (
            $status, $monthly, $initialPeriod, $renewalPeriod, $discountedMonthly, $otherMax, $discountedOtherMax, $transferInfo
        );
    }
}

namespace ShockMedia\Generated\Domainregistration\CheckResult;
