...
// generated on 2025-12-21T18:16:01.781845501Z
...
class Server
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        return new Server
        (
            $fqdn, $type, $adminLevel, $ips, $slaRemarks, $slaName, $datacenter, $cloudName, $os, $packages, $monitored, $zabbixTriggers, $zabbixGraphItems, $zabbixWebCheckItems, $backupPlanSummary, $backupJobs
        );
    }
}
...
class Build
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        return new Build
        (
            $id, $appId, $projectFilePath, $deploy, $uploadDate, $latestBuildDate, $buildState
        );
    }
}
...
class App
{
    ...
    (
        ...
        public readonly string $name,
        public readonly string|null $description,
        public readonly \ShockMedia\Generated\Map\AppType|null $type,
        ...
        public readonly \ShockMedia\Generated\Map\AppStatus|null $status,
    ) {
    }
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        if ($decodedJson['type'] === NULL) {
            ...
            $type = \ShockMedia\Generated\Map\AppType::from($decodedJson['type']);
        }
        ...
        if ($decodedJson['status'] === NULL) {
            ...
            $status = \ShockMedia\Generated\Map\AppStatus::from($decodedJson['status']);
        }

        return new App
        (
            $id, $name, $description, $type, $project, $build, $override, $buildTemplate, $status
        );
    }
}
...
class Project
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        return new Project
        (
            $id, $name, $description, $appCount, $sla
        );
    }
}
...
class SlaDashboardCacheKey
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        return new SlaDashboardCacheKey
        (
            $customerId, $interval
        );
    }
...
class IncidentStats
{
    public function __construct
    (
        public readonly int|null $openLow,
        public readonly int|null $openMedium,
        public readonly int|null $openHigh,
        public readonly int|null $resolvedLow,
        public readonly int|null $resolvedMedium,
        public readonly int|null $resolvedHigh,
    ) {
    }

    public static function fromDecodedJson(array $decodedJson)
    {
        /** @var int|null $openLow */
        $openLow = $decodedJson['openLow'];

        /** @var int|null $openMedium */
        $openMedium = $decodedJson['openMedium'];

        /** @var int|null $openHigh */
        $openHigh = $decodedJson['openHigh'];

        /** @var int|null $resolvedLow */
        $resolvedLow = $decodedJson['resolvedLow'];

        /** @var int|null $resolvedMedium */
        $resolvedMedium = $decodedJson['resolvedMedium'];

        /** @var int|null $resolvedHigh */
        $resolvedHigh = $decodedJson['resolvedHigh'];

        return new IncidentStats
        (
            $openLow, $openMedium, $openHigh, $resolvedLow, $resolvedMedium, $resolvedHigh
        );
    }
}
...
class TelephoneStats
{
    public function __construct
    (
        public readonly string $timeBucket,
        public readonly int $withinOfficeHours,
        public readonly int $outsideOfficeHours,
    ) {
    }

    public static function fromDecodedJson(array $decodedJson)
    {
        /** @var string $timeBucket */
        $timeBucket = $decodedJson['timeBucket'];

        /** @var int $withinOfficeHours */
        $withinOfficeHours = $decodedJson['withinOfficeHours'];

        /** @var int $outsideOfficeHours */
        $outsideOfficeHours = $decodedJson['outsideOfficeHours'];

        return new TelephoneStats
        (
            $timeBucket, $withinOfficeHours, $outsideOfficeHours
        );
    }
}
...
class ServerUptimeStats
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        (
            $serverFqdn, $serverUptime, $serverDowntime, $networkUptime, $slaDeviation
        );
    }
}
...
{
    /**
     * @param \ShockMedia\Generated\Sladashboard\BackupStatistics\Statistic[] $statistics
     */
    public function __construct
    (
    ...
    {
        $var0 = array();
        foreach ($decodedJson['statistics'] as $element0) {
            $var0[] = \ShockMedia\Generated\Sladashboard\BackupStatistics\Statistic::fromDecodedJson($element0);
        }
        /** @var \ShockMedia\Generated\Sladashboard\BackupStatistics\Statistic[] $statistics */
        $statistics = $var0;
...
class SlaDefinition
{
    ...
    (
        ...
        public readonly float $appUptimeThreshold,
    ) {
    }
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        /** @var float $appUptimeThreshold */
        $appUptimeThreshold = $decodedJson['appUptimeThreshold'];

        return new SlaDefinition
        (
            $slaName, $serverUptimeThreshold, $networkUptimeThreshold, $appUptimeThreshold
        );
    }
}
...
class ServerStats
{
    ...
    (
        public readonly string $timeBucket,
        public readonly float $manualActivityCount,
        public readonly float $automaticActivityCount,
    ) {
    }
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        /** @var float $manualActivityCount */
        $manualActivityCount = $decodedJson['manualActivityCount'];

        /** @var float $automaticActivityCount */
        $automaticActivityCount = $decodedJson['automaticActivityCount'];

        return new ServerStats
        (
            $timeBucket, $manualActivityCount, $automaticActivityCount
        );
    }
}

namespace ShockMedia\Generated\Sladashboard\BackupStatistics;
...
class Statistic
{
    ...
    (
        public readonly string $serverName,
        public readonly int $backupsAmount,
        public readonly int $checkupsAmount,
        public readonly string|null $lastCheckupTime,
        public readonly string|null $lastBackupTime,
    ) {
    }
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        /** @var int $backupsAmount */
        $backupsAmount = $decodedJson['backupsAmount'];

        /** @var int $checkupsAmount */
        $checkupsAmount = $decodedJson['checkupsAmount'];

        /** @var string|null $lastCheckupTime */
        $lastCheckupTime = $decodedJson['lastCheckupTime'];

        /** @var string|null $lastBackupTime */
        $lastBackupTime = $decodedJson['lastBackupTime'];

        return new Statistic
        (
            $serverName, $backupsAmount, $checkupsAmount, $lastCheckupTime, $lastBackupTime
        );
    }
}
...
class AcquiredOffering
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        (
            $acquiredId, $discount, $surcharge, $quantity, $start, $startContract, $end, $earliestCancellationDate, $offeringCategory, $offeringType, $offeringName, $offeringPrice, $effectivePrice, $serviceName, $accountName, $mapProject, $servers, $domainInfo, $extension
        );
    }
}
...
class DomainInfo
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        (
            $domainName, $authCodeAvailable, $transferLocked, $legacy
        );
    }
}
...
class BuildFilter
{
    public function __construct
    (
        public readonly bool|null $hasAppBundle,
    ) {
    }

    public static function fromDecodedJson(array $decodedJson)
    {
        /** @var bool|null $hasAppBundle */
        $hasAppBundle = $decodedJson['hasAppBundle'];
...
class AppFilter
{
     ...
     * @param \ShockMedia\Generated\Map\AppStatus[]|null $appStatus
     */
    public function __construct
    (
        public readonly string|null $nameLike,
        ...
        public readonly array|null $appStatus,
        public readonly \ShockMedia\Generated\Map\AppType|null $type,
    ) {
    }
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        if ($decodedJson['appStatus'] === NULL) {
            $var0 = NULL;
        } else {
            $var0 = array();
            foreach ($decodedJson['appStatus'] as $element0) {
                $var0[] = \ShockMedia\Generated\Map\AppStatus::from($element0);
            }
        }
        /** @var \ShockMedia\Generated\Map\AppStatus[]|null $appStatus */
        $appStatus = $var0;
        ...
        (
            $nameLike, $projectId, $buildTemplateLike, $buildState, $appStatus, $type
        );
    }
}
