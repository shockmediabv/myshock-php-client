...
// generated on 2024-10-24T17:45:23.047704280Z
...
class Server
{
    ...
    public static function fromDecodedJson(array $decodedJson)
    {
        ...
        return new Server
        (
            $fqdn, $type, $adminLevel, $ips, $slaRemarks, $slaName, $datacenter, $os, $packages, $monitored, $zabbixTriggers, $zabbixGraphItems, $backupPlanSummary, $backupJobs
        );
    }
}
